...
public enum GpxParameter {
	...
	GPX_COL_TIME_SPAN("timeSpan", "long", Long.class, 0),
	GPX_COL_TIME_MOVING("timeMoving", "long", Long.class, 0),
	...
	GPX_COL_FILE_LAST_MODIFIED_TIME("fileLastModifiedTime", "long", Long.class, 0),
	GPX_COL_FILE_LAST_UPLOADED_TIME("fileLastUploadedTime", "long", Long.class, 0),
	GPX_COL_FILE_CREATION_TIME("fileCreationTime", "long", Long.class, -1),
