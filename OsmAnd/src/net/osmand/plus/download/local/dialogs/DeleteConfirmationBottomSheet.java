...
public class DeleteConfirmationBottomSheet extends MenuBottomSheetDialogFragment {
	...
	public void createMenuItems(Bundle savedInstanceState) {
		CharSequence name = LocalItemUtils.getItemName(requireContext(), localItem);
		items.add(new BottomSheetItemWithDescription.Builder()
				.setDescription(getString(R.string.delete_map_description, name))
	...
	public static void showInstance(@NonNull FragmentManager manager, @NonNull Fragment target, @NonNull LocalFileItem localItem) {
	...
	public interface ConfirmDeletionListener {
		void onDeletionConfirmed(@NonNull LocalFileItem localItem);
	}
}
