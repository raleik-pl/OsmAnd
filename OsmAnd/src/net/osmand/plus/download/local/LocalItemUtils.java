...
public class LocalItemUtils {
	...
	public static void updateItem(@NonNull OsmandApplication app, @NonNull LocalFileItem item) {
	...
	public static boolean addUnique(@NonNull List<LocalFileItem> results, @NonNull List<LocalFileItem> items) {
		int size = results.size();
		for (LocalFileItem item : items) {
			boolean needAdd = true;
			for (LocalFileItem result : results) {
	...
	@NonNull
	public static CharSequence getItemName(@NonNull Context context, @NonNull LocalFileItem item) {
		LocalItemType type = item.getType();
	...
	@NonNull
	public static String getItemDescription(@NonNull Context context, @NonNull LocalFileItem item) {
